    ...
    >
      ...
      <div style={{ padding: '14px 18px', display: 'flex', gap: 14, alignItems: 'flex-start' }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: cita.cliente?.telefono ? 2 : 5 }}>
          ...
          {cita.cliente?.telefono && (
            <a
              ...
              style={{ display: 'flex', alignItems: 'center', gap: 4, fontSize: 12, color: '#C9A84C', marginBottom: 5, textDecoration: 'none' }}
            >
